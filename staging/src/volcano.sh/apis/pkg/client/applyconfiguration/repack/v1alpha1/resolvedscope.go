...
// apply.
func ResolvedScope() *ResolvedScopeApplyConfiguration {
	return &ResolvedScopeApplyConfiguration{}
}

// WithPodGroupCount sets the PodGroupCount field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the PodGroupCount field is set to the value of the last call.
func (b *ResolvedScopeApplyConfiguration) WithPodGroupCount(value int32) *ResolvedScopeApplyConfiguration {
	b.PodGroupCount = &value
	return b
}
...
func (b *ResolvedScopeApplyConfiguration) WithNodeCount(value int32) *ResolvedScopeApplyConfiguration {
	b.NodeCount = &value
	return b
}
